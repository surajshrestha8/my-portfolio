...
export const projects: Project[] = [
  {
    ...
    description:
      "A data visualization dashboard with interactive 3D charts and real-time updates.",
  ...
  },
  {
    ...
    description:
      "A browser-based virtual reality experience with interactive elements and spatial audio.",
  ...
  },
  {
    ...
    description:
      "An interactive 3D product customization tool for an e-commerce platform.",
